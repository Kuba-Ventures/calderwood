    ...
    <section className="relative">
      <div className="mx-auto max-w-container px-6 sm:px-8 pt-20 pb-20 sm:pt-28 sm:pb-24">
        ...
        <p className="mt-6 max-w-[640px] text-pretty text-lg leading-relaxed text-ink-700 sm:text-xl">
          A code-by-code benchmark of your fee schedule against UCR data in your zip code, delivered within 24 hours. Most independent practices are reimbursed 15–35% below the 75th percentile in their metro — a gap that typically runs $40,000 to $120,000 per provider per year.
        </p>
        <div className="mt-10 flex flex-col items-start gap-3">
          ...
          >
            Find out what you&rsquo;re leaving on the table — $199
          </a>
